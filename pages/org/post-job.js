...
export default function PostJob () {
    ...
    const handleFirestoreWriteDocument = async () => {
        ...
        //if document right was succesfull, upload image
        if(docRef.id){
            ...
            console.log('There was a problem creating document');
        ...
        <main className={styles.container}>
            <div className={styles.wrapper}>
                ...
                <form autoComplete="off" onSubmit={handleSubmit}>
                    ...
                    <div className={styles.inputBlockMain}>
                        <label className={styles.label}>optional: Add cover image </label>
                        <input 
                        className={styles.inputField}
                        type="file"
                        accept="image/*"
